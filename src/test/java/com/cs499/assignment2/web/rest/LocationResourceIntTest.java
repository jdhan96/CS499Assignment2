...
public class LocationResourceIntTest {
    ...
    private static final String DEFAULT_STREET_ADD = "AAAAAAAAAA";
    private static final String UPDATED_STREET_ADD = "BBBBBBBBBB";
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getStreetAdd()).isEqualTo(DEFAULT_STREET_ADD);
    ...
    public void createLocationWithExistingId() throws Exception {
        ...
        restLocationMockMvc.perform(post("/api/locations")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingLocation)))
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].streetAdd").value(hasItem(DEFAULT_STREET_ADD.toString())))
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.streetAdd").value(DEFAULT_STREET_ADD.toString()))
    ...
    public void updateLocation() throws Exception {
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getStreetAdd()).isEqualTo(UPDATED_STREET_ADD);
